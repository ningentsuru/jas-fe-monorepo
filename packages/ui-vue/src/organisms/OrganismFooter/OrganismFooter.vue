          ...
          <div class="space-y-4">
            ...
            <div class="space-y-3 pt-1">
              <div class="flex items-center gap-2.5">
                <AtomSkeleton class="size-4 rounded-full" /><AtomSkeleton
                  class="h-4 w-44 rounded"
                />
              </div>
              <div class="flex items-center gap-2.5">
                <AtomSkeleton class="size-4 rounded-full" /><AtomSkeleton
              ...
              <div class="flex items-center gap-2.5">
                <AtomSkeleton class="size-4 shrink-0 rounded-full" /><AtomSkeleton
        ...
        <div class="animate-fade-in grid grid-cols-1 items-start gap-8 md:grid-cols-2">
          <div class="space-y-4">
            ...
            <div class="space-y-2.5 pl-0.5 text-sm font-medium">
              ...
              >
                <Mail class="size-4 transition-transform group-hover:scale-105" />
              ...
              <a
                ...
                class="text-muted-foreground hover:text-primary group flex items-center gap-2.5 transition-colors"
              >
                <Phone class="size-4 transition-transform group-hover:scale-105" />
          ...
          <form @submit.prevent="handleLocalSubmit" class="space-y-3">
            <div class="space-y-1">
            ...
            >
              ...
              <template v-else-if="submitSuccess">
                <CheckCircle2 class="mr-1.5 size-4 text-emerald-400" />
